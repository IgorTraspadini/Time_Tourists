...
function ChatComponent(props) {
  ...
  useEffect(() => {
    ...
    async function getOpenAIResponse() {
      const prompt = 'What are the itinerary of things related to' + props.interested + 'that I must see in ' + props.where + ' on ' + props.when + 'in a very summarised way no longer than 130 tokens using bullet points style "->"'
